...
| `controller.persistence.size`                                  | PVC Storage Request for Kafka data volume                                                                                                                                                     | `1Gi`                     |
...
| `controller.logPersistence.size`                               | PVC Storage Request for Kafka logs volume                                                                                                                                                     | `1Gi`                     |
...
| `broker.persistence.size`                                  | PVC Storage Request for Kafka data volume                                                                                                                                                     | `1Gi`                     |
...
| `broker.logPersistence.size`                               | PVC Storage Request for Kafka logs volume                                                                                                                                                     | `1Gi`                     |
...
| `zookeeper.persistence.size`            | Persistent Volume size                                                                                                                                                  | `1Gi`               |
